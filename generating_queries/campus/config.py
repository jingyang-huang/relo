...
DATASET_FOLDER = './generating_queries/campus'
...
TRAIN_FILE = './generating_queries/campus/training_queries_baseline_occ.pickle'
TEST_FILE = './generating_queries/campus/test_queries_baseline_occ.pickle'
...
EVAL_DATABASE_FILE = './generating_queries/campus/campus_evaluation_database.pickle'
EVAL_QUERY_FILE = './generating_queries/campus/campus_evaluation_query.pickle'
